# Contributor Covenant Code of Conduct for the `Canada.ca Jekyll boilerplate` project

([Français](#Code-de-conduite-pour-le-projet-Gabarit-Jekyll-de-Canada.ca))
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at [`youremail@domain.ca`].
...
([English](#Contributor-Covenant-Code-of-Conduct-for-the-Canada.ca-Jekyll-boilerplate-project))
...
Les cas de comportement abusif, de harcèlement ou d'autres comportements inacceptables peuvent être rapportés en communiquant avec l'équipe de projet à l'adresse suivante :[`votrecourriel@domaine.ca`].
