...
oq export avg_losses-stats -1 -e csv -d output/BC/
mv output/BC/avg_losses-mean*.csv output/BC/ebR_BC5920A_avg_losses-stats_r1.csv;
oq export agg_curves-stats -1 -e csv -d output/BC/
mv output/BC/agg_curves-stats*.csv output/BC/ebR_BC5920A_agg_curves-stats_r1.csv;
oq export agg_losses-stats -1 -e csv -d output/BC/
mv output/BC/agg_losses-mean*.csv output/BC/ebR_BC5920A_agg_losses-stats_r1.csv;
# =================================================================
# BC5920B
# =================================================================
# Baseline Conditions
...
oq export avg_losses-stats -1 -e csv -d output/BC/
mv output/BC/avg_losses-mean*.csv output/BC/ebR_BC5920B_avg_losses-stats_r1.csv;
oq export agg_curves-stats -1 -e csv -d output/BC/
mv output/BC/agg_curves-stats*.csv output/BC/ebR_BC5920B_agg_curves-stats_r1.csv;
oq export agg_losses-stats -1 -e csv -d output/BC/
mv output/BC/agg_losses-mean*.csv output/BC/ebR_BC5920B_agg_losses-stats_r1.csv;
# =================================================================
# BC5930
# =================================================================
# Baseline Conditions
