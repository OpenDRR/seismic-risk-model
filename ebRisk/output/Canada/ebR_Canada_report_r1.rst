ebRisk-Stochastic ebRisk model for Canada; r1 retrofit
======================================================

============== ====================
checksum32     80_830_090          
date           2021-05-22T04:55:04 
...
minimum_intensity               {'SA(0.3)': 0.02, 'SA(0.5)': 0.05, 'SA(0.6)': 0.05, 'SA(1.0)': 0.05, 'SA(2.0)': 0.05}                                                                                                                                                                                                                                        
random_seed                     24                                                                                                                                                                                                                                                                                                                           
master_seed                     25                                                                                                                                                                                                                                                                                                                           
ses_seed                        23                                                                                                                                                                                                                                                                                                                           
avg_losses                      True                                                                                                                                                                                                                                                                                                                         
...
job_ini                     `ebRisk_r1_Canada.ini <ebRisk_r1_Canada.ini>`_                              
...
ebrisk             852    16_411  16%    10_026  36_453 
get_eid_rlz        213    19      45%    0.88750 36     
post_risk          46     0.30416 88%    0.11444 1.45860
read_source_model  6      0.16385 9%     0.13833 0.18325
sample_ruptures    101    250     103%   2.34708 1_357  
start_ebrisk       213    6_382   71%    564     27_233 
================== ====== ======= ====== ======= =======
...
sample_ruptures   srcfilter=1.17 GB param=51.44 MB sources=450.88 KB 2.22 GB  
get_eid_rlz       proxies=1.04 GB                                    174.14 MB
start_ebrisk      rgetter=1.05 GB param=1.84 MB                      11.08 GB 
ebrisk            rupgetter=714.11 MB param=7.81 MB                  43.37 GB 
post_risk         kr_losses=371.6 MB builder=99.23 KB                203.66 KB
================= ================================================== =========

Slowest operations
------------------
========================== ========== ========= ==========
calc_96, maxmem=595.3 GB   time_sec   memory_mb counts    
========================== ========== ========= ==========
total ebrisk               13_981_975 668       852       
getting hazard             11_836_361 21_626    1_065     
aggregating losses         2_205_178  0.0       69_187_538
total start_ebrisk         1_359_268  915       1_065     
computing risk             1_107_529  0.0       69_187_538
EbriskCalculator.run       174_301    11_306    1         
getting ruptures           172_078    0.0       9_978_072 
total sample_ruptures      25_277     1_294     170       
averaging losses           11_799     0.0       69_187_538
getting assets             10_634     562       1_065     
getting crmodel            6_267      266       1_065     
total get_eid_rlz          4_181      4.83203   213       
EventBasedCalculator.run   2_675      11_286    1         
importing inputs           677        10_791    1         
saving ruptures and events 529        336       1         
reading exposure           198        495       1         
saving ruptures            82         66        170       
PostRiskCalculator.run     74         10        1         
src_loss_table             63         0.0       1         
saving avg_losses          42         11        1_065     
total post_risk            13         0.0       46        
saving agg_loss_table      9.31253    5.92969   1_065     
composite source model     8.52078    0.98438   1         
total read_source_model    0.98308    2.59375   6         
========================== ========== ========= ==========