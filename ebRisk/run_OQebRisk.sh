...
for region in "${regions[@]}"; do
    ...
    ### RUN RISK CALCS
    oq engine --run input/ebRisk_b0_${region}.ini input/ebRisk_b0_EP_${region}.ini input/ebRisk_r1_${region}.ini input/ebRisk_r1_EP_${region}.ini &> output/${prov}/ebR_${region}_b0r1.log;
