...
mv output/AB/report*.rst output/AB/cH_AB_report.rst
...
mv output/MB/report*.rst output/MB/cH_MB_report.rst
...
mv output/NB/report*.rst output/NB/cH_NB_report.rst
...
mv output/NL/report*.rst output/NL/cH_NL_report.rst
...
mv output/NS/report*.rst output/NS/cH_NS_report.rst
...
mv output/NT/report*.rst output/NT/cH_NT_report.rst
...
mv output/NU/report*.rst output/NU/cH_NU_report.rst
...
mv output/ON/report*.rst output/ON/cH_ON_report.rst
...
mv output/PE/report*.rst output/PE/cH_PE_report.rst
...
mv output/QC/report*.rst output/QC/cH_QC_report.rst
...
mv output/SK/report*.rst output/SK/cH_SK_report.rst
...
mv output/YT/report*.rst output/YT/cH_YT_report.rst
