...
oq export fullreport -1 -e rst -d output/BC/
mv output/BC/report*.rst output/BC/eD_BC5920A_report_b0.rst
oq export realizations -1 -e csv -d output/BC/
...
# Level 2 Retrofit
oq engine --run input/eDamage_r1_BC5920A.ini &> output/BC/eD_BC5920A.log
oq export fullreport -1 -e rst -d output/BC/
mv output/BC/report*.rst output/BC/eD_BC5920A_report_r1.rst
oq export avg_damages-stats -1 -e csv -d output/BC/
...
oq export fullreport -1 -e rst -d output/BC/
mv output/BC/report*.rst output/BC/eD_BC5920B_report_b0.rst
oq export realizations -1 -e csv -d output/BC/
...
# Level 2 Retrofit
oq engine --run input/eDamage_r1_BC5920B.ini &> output/BC/eD_BC5920B.log
oq export fullreport -1 -e rst -d output/BC/
mv output/BC/report*.rst output/BC/eD_BC5920A_report_r1.rst
oq export avg_damages-stats -1 -e csv -d output/BC/
